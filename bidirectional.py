...
"Bingham82","Columbia2","Harvard1","MU78","Northwestern25","Rice31","Temple83","UC64","UGA50","Vanderbilt48","William77Ar"]

def generate_edges(folder_name):

    FILE =  folder_name + "/" + folder_name + ".edgelist"
    OUTFILE = folder_name + "/" + folder_name + "_bidirectional.edgelist"
